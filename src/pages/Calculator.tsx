...
const CalculatorPage = () => {
  ...
  return (
    <div className="container max-w-[1100px] mx-auto px-6 py-8 space-y-6">
      {/* Header */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div>
            <h1 className="text-2xl font-bold text-foreground">حاسبة أرباح المنتجات</h1>
            <p className="text-sm text-muted-foreground">احسب أرباحك بدقة مع كل التكاليف</p>
          </div>
